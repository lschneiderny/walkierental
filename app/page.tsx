      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <button className="w-full bg-[color:var(--success)] hover:bg-[color:var(--success-hover)] text-white px-4 py-2 rounded text-xs font-semibold uppercase tracking-wide transition-colors mb-3">Add to Cart</button>
