    ...
    <div className="pt-16">
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-[color:var(--background)] text-black/60 dark:text-white/60">or continue with</span>
        </div>
      </div>
      ...
      <div className="space-y-3 mb-8">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-black/10 dark:border-white/10 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition-colors disabled:opacity-50"
        >
        ...
        <p className="text-center text-sm text-black/60 dark:text-white/60">
          No account? <a href="/register" className="text-[color:var(--primary)] hover:underline font-medium">Register</a>
        </p>
      </div>
    </div>
  );
