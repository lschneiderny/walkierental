...
export default function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-black/10 dark:border-white/10 mt-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          {/* Get To Know Us */}
          <div className="md:col-span-1">
            <h3 className="font-semibold text-sm mb-3">Get To Know Us</h3>
            <ul className="space-y-2 text-sm text-black/60 dark:text-white/60">
              ...
              <li><Link href="/newsletter" className="hover:text-black dark:hover:text-white transition-colors">Newsletter</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm text-black/60 dark:text-white/60">
              <li><Link href="/rental-agreement" className="hover:text-black dark:hover:text-white transition-colors">Rental Agreement</Link></li>
              <li><Link href="/help" className="hover:text-black dark:hover:text-white transition-colors">Help</Link></li>
              <li><Link href="/process" className="hover:text-black dark:hover:text-white transition-colors">Our Process</Link></li>
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/10 flex items-center justify-center hover:bg-black/10 dark:hover:bg-white/20 transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-black/10 dark:border-white/10">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-black/60 dark:text-white/60">
            <p>&copy; {new Date().getFullYear()} WalkieRentals. All rights reserved.</p>
            <div className="mt-4 sm:mt-0 flex space-x-6">
              ...
              <Link href="/sitemap" className="hover:text-black dark:hover:text-white transition-colors">Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
