        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="md:col-span-3">
            ...
            <div className="space-y-2 text-sm text-black/60 dark:text-white/60">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:555-555-5555" className="hover:text-[color:var(--primary)] transition-colors">212-555-5555</a>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2 text-sm text-black/60 dark:text-white/60">
              ...
              <li><Link href="/about" className="hover:text-[color:var(--primary)] hover:translate-x-1 inline-block transition-all">About Us</Link></li>
              <li><Link href="/process" className="hover:text-[color:var(--primary)] hover:translate-x-1 inline-block transition-all">How It Works</Link></li>
              <li><Link href="/contact" className="hover:text-[color:var(--primary)] hover:translate-x-1 inline-block transition-all">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <a href="#" aria-label="Facebook" className="w-9 h-9 rounded-lg bg-black/5 dark:bg-white/10 flex items-center justify-center hover:bg-[color:var(--primary)] hover:text-white transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"/>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-lg bg-black/5 dark:bg-white/10 flex items-center justify-center hover:bg-[color:var(--primary)] hover:text-white transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="#" aria-label="YouTube" className="w-9 h-9 rounded-lg bg-black/5 dark:bg-white/10 flex items-center justify-center hover:bg-[color:var(--primary)] hover:text-white transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
